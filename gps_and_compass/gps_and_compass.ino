...
void doGPS()
{
  ...
  gps.listen();
  //print_int(tiny_gps.satellites(), TinyGPS::GPS_INVALID_SATELLITES, 5);
  //print_int(tiny_gps.hdop(), TinyGPS::GPS_INVALID_HDOP, 5);
  tiny_gps.f_get_position(&flat, &flon, &age);
  //print_float(flat, TinyGPS::GPS_INVALID_F_ANGLE, 10, 6);
  //print_float(flon, TinyGPS::GPS_INVALID_F_ANGLE, 11, 6);
  //print_int(age, TinyGPS::GPS_INVALID_AGE, 5);
  //print_date(tiny_gps);
  //print_float(tiny_gps.f_altitude(), TinyGPS::GPS_INVALID_F_ALTITUDE, 7, 2);
  // print_float(tiny_gps.f_course(), TinyGPS::GPS_INVALID_F_ANGLE, 7, 2);
  //print_float(tiny_gps.f_speed_kmph(), TinyGPS::GPS_INVALID_F_SPEED, 6, 2);
  Serial.print("GPS::");
  Serial.println();
